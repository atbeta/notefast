...
* **ai:** include current doc content in chat prompt context ([963ef61](https://github.com/atbeta/notefast/commit/963ef6173a29c9e74023846493ce36a01095e2a7))
...
* **server,web:** login audit log with IP/device tracking ([10245d2](https://github.com/atbeta/notefast/commit/10245d2e14d90e75f8e365b3f7a6e57a21999cd2))
...
* **ui:** HelpTip compact tooltips for settings; guard image-only chats without vision ([a52a68b](https://github.com/atbeta/notefast/commit/a52a68bf5e08872c9dda0e6c4b072b9ec9a938f9))
* **ui:** redesign settings as single-page dashboard and refine border radius ([d22a9c5](https://github.com/atbeta/notefast/commit/d22a9c51fc66c745624f703428d93bfef5780cff))
...
* **web,server:** auto-save editor drafts + cross-platform shortcut display ([ce06d51](https://github.com/atbeta/notefast/commit/ce06d51ef7dd4296b365d5790bf206c7c224bee3))
...
* pinned views rename (API + inline edit) ([a211725](https://github.com/atbeta/notefast/commit/a2117256a49e07d579fdfbdb8094e260a924218f))
...
* reranker preset persistence; catch image error in streamChat fallback ([c92c1fa](https://github.com/atbeta/notefast/commit/c92c1fa400fa6bb96a3c238a94dc5ec39024c15c))
