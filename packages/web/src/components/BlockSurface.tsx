  ...
  return (
    <>
      <button
        ...
        className={`absolute z-sticky hidden sm:inline-flex w-6 h-6 items-center justify-center rounded-md text-muted-foreground hover:text-foreground hover:bg-accent transition-colors print:hidden ${visibility} ${className}`}
      >
