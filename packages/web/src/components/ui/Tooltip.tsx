    ...
    >
      ...
      {style &&
        createPortal(
          <span
            role="tooltip"
            className="pointer-events-none fixed z-[300] whitespace-nowrap rounded-md bg-ink px-2 py-1 text-[11px] font-medium text-ink-foreground shadow-[var(--shadow-floating)]"
            style={style}
          >
            {label}
          </span>,
