  ...
  return createPortal(
    <div className="fixed inset-0 z-dialog flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative bg-card rounded-lg border border-border shadow-2xl shadow-black/40 w-full max-w-4xl max-h-[min(80vh,720px)] flex flex-col overflow-hidden animate-fade-in"
      >
